...
/**
 * Developer Console — Order/Payment reconciliation diagnostics.
 * SecurityConfig: /api/dev/** → ROLE_DEVELOPER.
 * Core logic lives in payment/reconciliation (unchanged).
 */
@RestController
@RequestMapping("/api/dev/reconciliation")
@RequiredArgsConstructor
@Tag(name = "Developer Reconciliation", description = "결제·주문 정합성 진단 API")
public class DeveloperReconciliationController {
